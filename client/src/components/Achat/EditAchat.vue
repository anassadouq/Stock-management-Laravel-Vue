...
const toast = useToast(); // ✅ Définition correcte
...
// ✅ Ajouter client_id dans form dès l'initialisation
const form = reactive({
    client_id: client_id,  // 🔹 Assigner client_id directement
    product_id: '',
    qte: '',
});
...
const fetchAchat = async () => {
    try {
        ...
        form.client_id = achat.client_id || form.client_id; // 🔹 Ne pas écraser si `null`
...
const handleUpdate = async () => {
    ...
    try {
        ...
        router.push(`/client`);  // 🔹 Rediriger vers la page correcte
    } catch (error) {
                ...
                <form @submit.prevent="handleUpdate">
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.product_id"
                                name="product_id"
                                class="border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-500 w-full px-4 py-2">

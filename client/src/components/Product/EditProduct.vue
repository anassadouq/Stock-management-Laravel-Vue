            ...
            <div>
                <form @submit.prevent="handleUpdate">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" v-model="form.designation" placeholder="Designation" />
                    </div>

                    <div class="mb-4">
                        <label for="qte">Quantity</label>
                        <input type="number" v-model="form.qte" placeholder="Quantity" />
                    </div>

                    <div class="mb-4">
                        <label for="pu">Price</label>
                        <input type="number" step="0.01" v-model="form.pu" placeholder="Price" />
                    </div>
